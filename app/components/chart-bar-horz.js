...
export default Component.extend({
  ...
  draw(){
    ...
    const y = scaleBand().range([0, chartWidth]).padding(0.4);
    ...
    const bottomScale = container.append("g").call(axisLeft(y));
    ...
    const x = scaleLinear().range([chartHeight, 0]);
    ...
    container.append("g").call(axisLeft(x))
      .selectAll("text")
      .attr("y", -8)
    ...
    container.selectAll('.bar').data(dataOrArray).enter()
      ...
      .attr('height', d => chartHeight - x(d.total))
