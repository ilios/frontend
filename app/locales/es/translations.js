export default {
  'general': {
    ...
    'attribute': 'Atributo',
    'author': 'Autor',
    'autoUpdatingSeconds': { 'one': 'Actualización automática en 1 segundo...', 'other': 'Actualización automática en {{count}} segundos...' },
    ...
    'draft': 'Borrador',
    'duration': 'Duración',
    'durationHours': { 'one': 'un hora', 'other': '{{count}} horas'},
    'durationInDays': 'Duración (en Días)',
    'durationInYears': 'Duración (en Años)',
    'durationMinutes': { 'one': '1 minuto', 'other': '{{count}} minutos'},
    'edit': 'Editar',
