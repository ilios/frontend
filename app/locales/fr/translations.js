export default {
  'general': {
    ...
    'instructorGroups': 'Groupes des Professeurs',
    'other': 'Autre',
    'singleDay': 'Seule Journée',
    'multiDay': 'de Plusieurs Jours',
    'classOf': 'Classe de {{year}}',
    'findInstructorOrGroup': 'Trouver Professeur ou Groupe',
    'selected': 'Sélectionné',
    'available': 'Disponible',
    'savedSuccessfully': 'Réussie sauvé',
    'notFoundMessage': "Merde! Je ne pouvais pas trouver cette chôse. S'il vous plaît vérifier votre adresse de la page et essayez à nouveau."
  },
  'programs': {
