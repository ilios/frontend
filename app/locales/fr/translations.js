export default {
  'general': {
    ...
    'attribute': 'Attribut',
    'author': 'Auteur',
    'autoUpdatingSeconds': { 'one': ' Mise à jour automatique en 1 seconde...', 'other': ' Mise à jour automatique en {{count}} secondes...' },
    ...
    'draft': 'Provisoire',
    'duration': 'Durée',
    'durationHours': { 'one': 'une heure', 'other': '{{count}} heures'},
    'durationInDays': 'Durée (en Jours)',
    'durationInYears': "Durée (en Années)",
    'durationMinutes': { 'one': 'une minute', 'other': '{{count}} minutes'},
    'edit': "Edite",
    ...
    'usersSelected': { 'one': '1 utilisateur sélectionné', 'other': '{{count}} utilisateurs sélectionnés' },
