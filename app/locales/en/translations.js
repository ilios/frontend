export default {
  'general': {
    ...
    'attribute': 'Attribute',
    'author': 'Author',
    'autoUpdatingSeconds': { 'one': 'Auto updating in 1 second...', 'other': 'Auto updating in {{count}} seconds...' },
    'available': 'Available',
    ...
    'draft': 'Draft',
    'duration': 'Duration',
    'durationHours': { 'one': '1 hour', 'other': '{{count}} hours'},
    'durationInDays': 'Duration (in Days)',
    'durationInYears': 'Duration (in Years)',
    'durationMinutes': { 'one': '1 minute', 'other': '{{count}} minutes'},
    'edit': 'Edit',
