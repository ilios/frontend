export default {
  'general': {
    ...
    'icsAdminInstructions': 'To add a users Ilios calendar to another application or service, they will need to use this URL.  This URL is like a password. Anyone who knows it can view this users calendar!',
    'icsFeed': 'ICS Feed',
    'include': 'Include',
    ...
    'noPermissionsInOtherSchools': 'You do not have the necessary permissions to add this user to any other schools',
    ...
    'updateUserFromDirectory': 'Update this user record with the campus directory',
