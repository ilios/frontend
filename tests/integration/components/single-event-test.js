...
module(
  'Integration | Component | ilios calendar single event',
  function (hooks) {
    ...
    test('it renders', async function (assert) {
      ...
      assert
        ...
        .containsText('test course', 'course title is displayed');
      assert
        .dom('.single-event-summary')
        .containsText('test session', 'session title is displayed');
      assert
        .dom('.single-event-location')
        .containsText('Session Link here', 'location is displayed');
      assert
        .dom('.single-event-location a')
        .hasProperty('href', 'https://example.edu/');
      assert
      ...
      assert
        .dom(
          `${firstSessionLm} .single-event-learningmaterial-item-description`
        )
      ...
      assert
        .dom(
          `${sessionObjectivesSelector} ul.tree > li:nth-of-type(1) li:nth-of-type(1)`
        )
        .hasText('Session Objective B');
      assert
        .dom(
          `${sessionObjectivesSelector} ul.tree > li:nth-of-type(1) li:nth-of-type(2)`
        )
      ...
      assert
        .dom(
          `${sessionObjectivesSelector} ul.tree > li:nth-of-type(2) li:nth-of-type(1)`
        )
      ...
      assert
        .dom(
          `${courseObjectivesSelector} ul.tree > li:nth-of-type(1) li:nth-of-type(1)`
        )
        .hasText('Course Objective B');
      assert
        .dom(
          `${courseObjectivesSelector} ul.tree > li:nth-of-type(1) li:nth-of-type(2)`
        )
      ...
      assert
        .dom(
          `${courseObjectivesSelector} ul.tree > li:nth-of-type(2) li:nth-of-type(1)`
        )
