...
module('Integration | Component | curriculum inventory sequence block min max editor', function(hooks) {
  ...
  test('it renders', async function(assert) {
    ...
    assert.dom('.minimum input').hasValue(block.minimum.toString(), 'Minimum input has correct value.');
    assert.dom('.maximum label').hasText('Maximum:', 'Maximum input is labeled correctly.');
    assert.dom('.maximum input').hasValue(block.maximum.toString(), 'Maximum input has correct value.');
