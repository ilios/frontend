...
module(
  'Integration | Component | detail-learners-and-learner-groups',
  function (hooks) {
    ...
    />`);
      ...
      assert.equal(
        component.detailLearnergroupsList.trees[0].subgroups.length,
        3
      );
      assert.equal(
      ...
      assert.equal(
        component.detailLearnergroupsList.trees[1].subgroups.length,
        1
      );
      assert.equal(
    ...
    />`);
      ...
      assert.equal(
        component.learnerSelectionManager.selectedLearners.detailLearnerList
          .learners.length,
        3
      );
      assert.equal(
        component.learnerSelectionManager.selectedLearners.detailLearnerList
          .learners[0].userNameInfo.fullName,
        '0 guy M. Mc0son'
      );
      assert.equal(
        component.learnerSelectionManager.selectedLearners.detailLearnerList
          .learners[1].userNameInfo.fullName,
        '1 guy M. Mc1son'
      );
      assert.equal(
        component.learnerSelectionManager.selectedLearners.detailLearnerList
          .learners[2].userNameInfo.fullName,
        '2 guy M. Mc2son'
      );
      assert.equal(
        component.learnergroupSelectionManager.selectedGroups.list.trees.length,
        2
      );
      assert.equal(
        component.learnergroupSelectionManager.selectedGroups.list.trees[0]
          .subgroups.length,
        3
      );
      assert.equal(
      ...
      assert.equal(
        component.learnergroupSelectionManager.selectedGroups.list.trees[1]
          .subgroups.length,
        1
      );
      assert.equal(
      ...
      assert.equal(
        component.learnergroupSelectionManager.availableGroups.cohorts.length,
        2
      );
      assert.equal(
      ...
      assert.equal(
        component.learnergroupSelectionManager.availableGroups.cohorts[0].trees
          .length,
        1
      );
      assert.equal(
        component.learnergroupSelectionManager.availableGroups.cohorts[0]
          .trees[0].title,
        'Top Group 1'
      );
      assert.notOk(
      ...
      assert.equal(
        component.learnergroupSelectionManager.availableGroups.cohorts[0]
          .trees[0].subgroups.length,
        2
      );
      assert.equal(
        component.learnergroupSelectionManager.availableGroups.cohorts[0]
          .trees[0].subgroups[0].title,
        'Second 1'
      );
      assert.ok(
        component.learnergroupSelectionManager.availableGroups.cohorts[0]
          .trees[0].subgroups[0].isHidden
      );
      assert.equal(
        component.learnergroupSelectionManager.availableGroups.cohorts[0]
          .trees[0].subgroups[1].title,
        'Second 2'
      );
      assert.ok(
        component.learnergroupSelectionManager.availableGroups.cohorts[0]
          .trees[0].subgroups[1].isHidden
      );
      assert.equal(
      ...
      assert.equal(
        component.learnergroupSelectionManager.availableGroups.cohorts[1].trees
          .length,
        2
      );
      assert.equal(
        component.learnergroupSelectionManager.availableGroups.cohorts[1]
          .trees[0].title,
        'Top Group 2'
      );
      assert.notOk(
