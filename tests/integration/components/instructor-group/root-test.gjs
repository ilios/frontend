...
module('Integration | Component | instructor-group/root', function (hooks) {
  ...
  test('it renders', async function (assert) {
    ...
    assert.strictEqual(component.header.breadcrumbs.crumbs.length, 3);
    assert.strictEqual(component.header.breadcrumbs.crumbs[0].text, 'Instructor Groups');
    assert.strictEqual(component.header.breadcrumbs.crumbs[1].text, 'school 0');
    assert.strictEqual(component.header.breadcrumbs.crumbs[2].text, 'instructor group 0');
