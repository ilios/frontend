...
import { component } from 'frontend/tests/pages/components/detail-learners-and-learner-groups';
import DetailLearnersAndLearnerGroups from 'frontend/components/detail-learners-and-learner-groups';
