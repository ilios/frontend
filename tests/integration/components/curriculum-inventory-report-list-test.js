...
module('Integration | Component | curriculum inventory report list', function (hooks) {
  ...
  test('it renders', async function (assert) {
    ...
    await render(
      hbs`<CurriculumInventoryReportList @reports={{this.reports}} @edit={{noop}} @remove={{noop}} />`
    );
    assert.equal(
  ...
  test('delete and confirm', async function (assert) {
    ...
    await render(
      hbs`<CurriculumInventoryReportList @reports={{this.reports}} @edit={{noop}} @remove={{this.removeAction}} />`
    );
  ...
  test('edit', async function (assert) {
    ...
    await render(
      hbs`<CurriculumInventoryReportList @reports={{this.reports}} @edit={{this.editAction}} @remove={{noop}} />`
    );
