...
module('Integration | Component | curriculum inventory report list', function (hooks) {
  ...
  test('it renders', async function (assert) {
    ...
    assert.notOk(
      component.reports[0].isDeletable,
      'Delete button is disabled for finalized reports.'
    );
  ...
  test('delete and confirm', async function (assert) {
    ...
    await render(
      hbs`<CurriculumInventoryReportList @reports={{this.reports}} @remove={{this.removeAction}} />`
    );
  ...
  test('edit', async function (assert) {
    ...
    await render(
      hbs`<CurriculumInventoryReportList @reports={{this.reports}} @edit={{this.editAction}} />`
    );
