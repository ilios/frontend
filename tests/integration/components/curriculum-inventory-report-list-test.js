...
module('Integration | Component | curriculum inventory report list', function (hooks) {
  ...
  test('it renders', async function (assert) {
    ...
    await render(hbs`<CurriculumInventoryReportList @reports={{this.reports}} @edit={{noop}} @remove={{noop}} />`);
  ...
  test('empty list', async function (assert) {
    await render(hbs`<CurriculumInventoryReportList @reports={{array}} @edit={{noop}} @remove={{noop}}/>`);
  ...
  test('delete and confirm', async function (assert) {
    ...
    await render(hbs`<CurriculumInventoryReportList @reports={{this.reports}} @edit={{noop}} @remove={{this.removeAction}} />`);
