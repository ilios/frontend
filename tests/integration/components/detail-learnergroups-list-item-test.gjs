...
import { component } from 'frontend/tests/pages/components/detail-learnergroups-list-item';
import DetailLearnergroupsListItem from 'frontend/components/detail-learnergroups-list-item';
