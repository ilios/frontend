...
module('Integration | Component | curriculum-inventory-verification-preview', function(hooks) {
  ...
  test('it renders', async function(assert) {
    ...
    assert.equal(component.tableOfContents.items.objectAt(0).link, '#verification-preview-table-1');
    ...
    assert.equal(component.tableOfContents.items.objectAt(7).link, '#verification-preview-table-7');
    assert.equal(component.tableOfContents.items.objectAt(8).text,'Table 8: All Resource Types');
    assert.equal(component.tableOfContents.items.objectAt(8).link, '#verification-preview-table-8');
