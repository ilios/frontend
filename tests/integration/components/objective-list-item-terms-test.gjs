...
import { component } from 'frontend/tests/pages/components/objective-list-item-terms';
import { setupMSW } from 'frontend/tests/msw';
import ObjectiveListItemTerms from 'frontend/components/objective-list-item-terms';
