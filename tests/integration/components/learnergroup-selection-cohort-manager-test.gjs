...
import { component } from 'frontend/tests/pages/components/learnergroup-selection-cohort-manager';
import LearnergroupSelectionCohortManager from 'frontend/components/learnergroup-selection-cohort-manager';
