...
module('Integration | Component | pagedlist controls', function(hooks) {
  ...
  test('go back', async function(assert) {
    ...
    await render(hbs`<PagedlistControls @offset={{90}} @limit={{10}} @total={{100}} @setOffset={{this.setOffset}} />`);
  ...
  test('go forward', async function(assert) {
    ...
    await render(hbs`<PagedlistControls @offset={{0}} @limit={{10}} @total={{100}} @setOffset={{this.setOffset}} />`);
