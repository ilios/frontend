...
module('Integration | Component | visualizer-course-instructor-term', function(hooks) {
  ...
  test('it renders', async function(assert) {
    ...
    const term1 = this.server.create('term', { vocabulary: vocabulary1, title: 'Standalone' });
    const term2 = this.server.create('term', { vocabulary: vocabulary2, title: 'Campaign' });
    ...
    await render(hbs`<VisualizerCourseInstructorTerm @course={{course}} @user={{instructor}} @isIcon={{false}} />`);
