...
test('as is action fires', function(assert) {
  assert.expect(2);
  this.set('click', ()=>{
...
test('publish action fires', function(assert) {
  assert.expect(2);
  this.set('click', ()=>{
    assert.ok(true, 'action fired');
  });
...
test('schedule action fires', function(assert) {
  assert.expect(2);
  this.set('click', ()=>{
    assert.ok(true, 'action fired');
  });
...
test('unpublish action fires', function(assert) {
  assert.expect(2);
  this.set('click', ()=>{
    assert.ok(true, 'action fired');
  });
