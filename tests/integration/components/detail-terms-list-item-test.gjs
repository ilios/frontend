...
import { component } from 'frontend/tests/pages/components/detail-terms-list-item';
import DetailTermsListItem from 'frontend/components/detail-terms-list-item';
