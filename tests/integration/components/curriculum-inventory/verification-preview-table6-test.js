...
module(
  ...
  function (hooks) {
    ...
    test('it renders', async function (assert) {
      ...
      assert.equal(component.table.firstHeadings[0].text, 'Clerkship Sequence Blocks');
      ...
      assert.equal(component.table.secondHeadings[2].text, 'baz');
      assert.equal(component.table.secondHeadings[3].text, 'Formative');
      assert.equal(component.table.secondHeadings[4].text, 'Narrative');
      assert.equal(component.table.rows.length, 2);
      assert.equal(component.table.rows[0].cells.length, 7);
      assert.equal(component.table.rows[0].cells[0].text, 'Alpha');
      assert.equal(component.table.rows[0].cells[1].text, '1');
      assert.equal(component.table.rows[0].cells[2].text, 'X');
      assert.equal(component.table.rows[0].cells[3].text, '');
      assert.equal(component.table.rows[0].cells[4].text, 'X');
      assert.equal(component.table.rows[0].cells[5].text, 'Y');
      assert.equal(component.table.rows[0].cells[6].text, '');
      assert.equal(component.table.rows[1].cells[0].text, 'Beta');
      assert.equal(component.table.rows[1].cells[1].text, '2');
      assert.equal(component.table.rows[1].cells[2].text, '');
      assert.equal(component.table.rows[1].cells[3].text, 'X');
      assert.equal(component.table.rows[1].cells[4].text, 'X');
      assert.equal(component.table.rows[1].cells[5].text, '');
      assert.equal(component.table.rows[1].cells[6].text, 'Y');
    });
  }
);
