...
import { component } from 'frontend/tests/pages/components/course/visualize-instructors';
import VisualizeInstructors from 'frontend/components/course/visualize-instructors';
