...
import { component } from 'frontend/tests/pages/components/course/visualize-term-graph';
import VisualizeTermGraph from 'frontend/components/course/visualize-term-graph';
