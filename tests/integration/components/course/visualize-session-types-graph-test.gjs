...
import { component } from 'frontend/tests/pages/components/course/visualize-session-types-graph';
import VisualizeSessionTypesGraph from 'frontend/components/course/visualize-session-types-graph';
