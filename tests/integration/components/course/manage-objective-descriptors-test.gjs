...
import { component } from 'frontend/tests/pages/components/course/manage-objective-descriptors';
import ManageObjectiveDescriptors from 'frontend/components/course/manage-objective-descriptors';
