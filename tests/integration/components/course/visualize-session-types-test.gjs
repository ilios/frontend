...
import { component } from 'frontend/tests/pages/components/course/visualize-session-types';
import VisualizeSessionTypes from 'frontend/components/course/visualize-session-types';
