...
import { component } from 'frontend/tests/pages/components/course/objective-list-item-parents';
import { setupMSW } from 'frontend/tests/msw';
import ObjectiveListItemParents from 'frontend/components/course/objective-list-item-parents';
