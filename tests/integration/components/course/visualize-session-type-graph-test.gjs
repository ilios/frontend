...
import { component } from 'frontend/tests/pages/components/course/visualize-session-type-graph';
import VisualizeSessionTypeGraph from 'frontend/components/course/visualize-session-type-graph';
