...
module(
  'Integration | Component | course/collapsed-objectives',
  function (hooks) {
    ...
    hooks.beforeEach(async function () {
      ...
      this.objectiveWithProgramYearObjectives = this.server.create(
        'course-objective',
        {
    ...
    test('displays summary data', async function (assert) {
      ...
      await render(
        hbs`<Course::CollapsedObjectives @course={{this.course}} @expand={{noop}} />`
      );
