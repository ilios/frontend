...
import { component } from 'frontend/tests/pages/components/course/collapsed-objectives';
import { setupMSW } from 'frontend/tests/msw';
import CollapsedObjectives from 'frontend/components/course/collapsed-objectives';
