...
import { component } from 'frontend/tests/pages/components/course/visualize-objectives-graph';
import VisualizeObjectivesGraph from 'frontend/components/course/visualize-objectives-graph';
