...
module('Integration | Component | school-curriculum-inventory-institution-manager', function(hooks) {
  ...
  test('form validation', async function (assert) {
    ...
    assert.equal(component.content.addressStateOrProvince.errorMessage, "This field can not be blank");
    ...
    assert.equal(component.content.addressCountryCode.errorMessage, "This field can not be blank");
  });
