...
module('Integration | Component | visualizer-course-vocabulary', function(hooks) {
  ...
  test('it renders', async function(assert) {
    ...
    const term1 = this.server.create('term', { vocabulary, title: 'Standalone' });
    const term2 = this.server.create('term', { vocabulary, title: 'Campaign' });
    ...
    await render(hbs`<VisualizerCourseVocabulary @course={{course}} @vocabulary={{vocabulary}} @isIcon={{false}} />`);
