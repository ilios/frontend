...
import { component } from 'frontend/tests/pages/components/session/manage-objective-parents';
import { a11yAudit } from 'ember-a11y-testing/test-support';
import { setupMSW } from 'frontend/tests/msw';
import ManageObjectiveParents from 'frontend/components/session/manage-objective-parents';
