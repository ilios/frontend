...
import { component } from 'frontend/tests/pages/components/session/objective-list-item-parents';
import { setupMSW } from 'frontend/tests/msw';
import ObjectiveListItemParents from 'frontend/components/session/objective-list-item-parents';
