...
import { component } from 'frontend/tests/pages/components/session/manage-objective-descriptors';
import ManageObjectiveDescriptors from 'frontend/components/session/manage-objective-descriptors';
