...
module(
  'Integration | Component | learnergroup-selection-manager',
  function (hooks) {
    ...
    hooks.beforeEach(async function () {
      ...
      this.topLevelLearnerGroup1 = await store.find(
        'learner-group',
        topLevelLearnerGroup1.id
      );
      this.topLevelLearnerGroup2 = await store.find(
        'learner-group',
        topLevelLearnerGroup2.id
      );
      this.topLevelLearnerGroup3 = await store.find(
        'learner-group',
        topLevelLearnerGroup3.id
      );
      this.secondLevelLearnerGroup1 = await store.find(
        'learner-group',
        secondLevelLearnerGroup1.id
      );
      this.secondLevelLearnerGroup2 = await store.find(
        'learner-group',
        secondLevelLearnerGroup2.id
      );
      this.secondLevelLearnerGroup3 = await store.find(
        'learner-group',
    ...
    />`);
      ...
      assert.ok(
        component.selectedGroups.list.trees[0].subgroups[0].needsAccommodation
      );
      assert.equal(
        component.selectedGroups.list.trees[0].subgroups[1].title,
        'Second 1 (0)'
      );
      assert.notOk(
        component.selectedGroups.list.trees[0].subgroups[1].needsAccommodation
      );
      assert.equal(
      ...
      assert.notOk(
        component.selectedGroups.list.trees[1].subgroups[0].needsAccommodation
      );
      assert.equal(
        component.selectedGroups.list.trees[1].subgroups[1].title,
        'Second 10 (0)'
      );
      assert.ok(
        component.selectedGroups.list.trees[1].subgroups[1].needsAccommodation
      );
      ...
      assert.equal(
        component.availableGroups.cohorts[0].title,
        'program 0 cohort 0'
      );
      assert.equal(component.availableGroups.cohorts[0].trees.length, 1);
      assert.equal(
        component.availableGroups.cohorts[0].trees[0].title,
        'Top Group 1'
      );
      assert.ok(
        component.availableGroups.cohorts[0].trees[0].needsAccommodation
      );
      assert.notOk(component.availableGroups.cohorts[0].trees[0].isHidden);
      assert.equal(
        component.availableGroups.cohorts[0].trees[0].subgroups.length,
        2
      );
      assert.equal(
      ...
      assert.ok(
        component.availableGroups.cohorts[0].trees[0].subgroups[0].isHidden
      );
      assert.equal(
      ...
      assert.ok(
        component.availableGroups.cohorts[0].trees[0].subgroups[1]
          .needsAccommodation
      );
      assert.notOk(
        component.availableGroups.cohorts[0].trees[0].subgroups[1].isHidden
      );
      assert.equal(
        component.availableGroups.cohorts[1].title,
        'program 0 cohort 1'
      );
      assert.equal(component.availableGroups.cohorts[1].trees.length, 2);
      assert.equal(
        component.availableGroups.cohorts[1].trees[0].title,
        'Top Group 2'
      );
      assert.notOk(
        component.availableGroups.cohorts[1].trees[0].needsAccommodation
      );
      assert.notOk(component.availableGroups.cohorts[1].trees[0].isHidden);
      assert.equal(
        component.availableGroups.cohorts[1].trees[0].subgroups.length,
        1
      );
      assert.equal(
      ...
      assert.ok(
        component.availableGroups.cohorts[1].trees[0].subgroups[0].isHidden
      );
      assert.equal(
        component.availableGroups.cohorts[1].trees[1].title,
        'Top Group 10'
      );
      assert.notOk(
        component.availableGroups.cohorts[1].trees[1].needsAccommodation
      );
      assert.notOk(component.availableGroups.cohorts[1].trees[1].isHidden);
      assert.equal(
        component.availableGroups.cohorts[1].trees[1].subgroups.length,
        0
      );
    });
