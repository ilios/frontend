...
module('Integration | Component | dashboard/courses-calendar-filter', function (hooks) {
  ...
  test('it renders and is accessible', async function (assert) {
    ...
    assert.strictEqual(component.years[0].title, thisYear - 1);
    assert.strictEqual(component.years[1].title, thisYear);
    assert.strictEqual(component.years[2].title, thisYear + 1);
