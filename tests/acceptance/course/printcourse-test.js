...
test('test print course learning materials', function(assert) {
  ...
  andThen(function() {
    ...
    assert.equal(find('.detail-view-details .detail-content tbody tr td:eq(4)').text().trim(), 'The flux capacitor requires 1.21 gigawatts of electrical power to operate, which is roughly equivalent to the power produced by 15 regular jet engines.\nLathrop, Emmett, Flux Capacitor, Journal of Time Travel, 5 Nov 1955');
