...
<div class="course-publicationcheck" data-test-course-publicationcheck {{scroll-into-view}}>
      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            {{/if}}
            {{#if (has-many-length @course "courseObjectives")}}
              <td class="yes" data-test-objectives>
                {{t "general.yes"}}
                ({{has-many-length @course "courseObjectives"}})
