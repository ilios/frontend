...
/>`);
  ...
  test('displays `None` when provided no content', async function (assert) {
    ...
    await render(
      hbs`<SingleEventObjectiveList @objectives={{this.objectives}} @isExpandedByDefault={{true}} />`,
    );
  ...
  test('collapsed by default', async function (assert) {
    ...
    await render(
      hbs`<SingleEventObjectiveList @objectives={{this.objectives}} @isExpandedByDefault={{false}} />`,
    );
