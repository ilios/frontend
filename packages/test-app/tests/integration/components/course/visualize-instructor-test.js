...
module('Integration | Component | course/visualize-instructor', function (hooks) {
  ...
  test('it renders', async function (assert) {
    ...
    await render(hbs`<Course::VisualizeInstructor @course={{this.course}} @user={{this.user}} />`);
  ...
  test('visualizations', async function (assert) {
    ...
    assert.ok(component.sessionTypesChart.chart.labels[0].text.includes('session type 1'));
    assert.ok(component.sessionTypesChart.chart.labels[1].text.includes('session type 0'));
  });
});
