...
import { component } from 'frontend/tests/pages/components/school-institutional-information-manager';
import SchoolInstitutionalInformationManager from 'frontend/components/school-institutional-information-manager';
import noop from 'ilios-common/helpers/noop';

module('Integration | Component | school-institutional-information-manager', function (hooks) {
  ...
  test('it renders', async function (assert) {
    ...
    assert.strictEqual(component.content.aamcCode.label, 'AAMC School ID (e.g. "Institution ID")');
  ...
  test('form validation', async function (assert) {
    ...
    await render(
      <template>
        <SchoolInstitutionalInformationManager @canUpdate={{this.canUpdate}} @manage={{(noop)}} />
      </template>,
    );
