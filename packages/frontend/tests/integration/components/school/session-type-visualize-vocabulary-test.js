...
module('Integration | Component | school/session-type-visualize-vocabulary', function (hooks) {
  ...
  test('it renders', async function (assert) {
    ...
    assert.ok(component.termsChart.chart.labels[0].text.includes('term 2'));
    assert.strictEqual(
    ...
    assert.ok(component.termsChart.chart.labels[1].text.includes('term 4'));
    assert.strictEqual(
    ...
    assert.ok(component.termsChart.chart.labels[2].text.includes('term 1'));
    assert.strictEqual(
    ...
    assert.ok(component.termsChart.chart.labels[3].text.includes('term 0'));
    assert.strictEqual(
    ...
    assert.ok(component.termsChart.chart.labels[4].text.includes('term 3'));
    assert.strictEqual(
