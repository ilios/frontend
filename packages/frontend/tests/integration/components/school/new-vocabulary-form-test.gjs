...
module('Integration | Component | school/new-vocabulary-form', function (hooks) {
  ...
  test('it renders', async function (assert) {
    ...
    await render(
      <template><NewVocabularyForm @school={{this.school}} @close={{(noop)}} /></template>,
    );
  ...
  test('close', async function (assert) {
    ...
    await render(
      <template><NewVocabularyForm @school={{this.school}} @close={{this.close}} /></template>,
    );
  ...
  test('save', async function (assert) {
    ...
    await render(
      <template>
        <NewVocabularyForm @school={{this.school}} @close={{(noop)}} @save={{this.save}} />
      </template>,
    );
