...
module('Integration | Component | school/root', function (hooks) {
  ...
  test('it renders expanded', async function (assert) {
    ...
    assert.ok(component.leadershipExpanded.isVisible);
    assert.notOk(component.leadershipCollapsed.isVisible);
    assert.ok(component.competenciesExpanded.isVisible);
    assert.notOk(component.competenciesCollapsed.isVisible);
    assert.ok(component.vocabulariesExpanded.isVisible);
    assert.notOk(component.vocabulariesCollapsed.isVisible);
    assert.ok(component.sessionTypesExpanded.isVisible);
    assert.notOk(component.sessionTypesCollapsed.isVisible);
    assert.ok(component.sessionAttributes.expanded.isVisible);
    assert.notOk(component.sessionAttributes.collapsed.isVisible);
    assert.ok(component.institutionalInformationDetails.isVisible);
    assert.notOk(component.institutionalInformationManager.isVisible);
  ...
  test('it renders collapsed', async function (assert) {
    ...
    assert.notOk(component.leadershipExpanded.isVisible);
    assert.ok(component.leadershipCollapsed.isVisible);
    assert.notOk(component.competenciesExpanded.isVisible);
    assert.ok(component.competenciesCollapsed.isVisible);
    assert.notOk(component.vocabulariesExpanded.isVisible);
    assert.ok(component.vocabulariesCollapsed.isVisible);
    assert.notOk(component.sessionTypesExpanded.isVisible);
    assert.ok(component.sessionTypesCollapsed.isVisible);
    assert.notOk(component.sessionAttributes.expanded.isVisible);
    assert.ok(component.sessionAttributes.collapsed.isVisible);
    assert.notOk(component.institutionalInformationManager.isVisible);
    assert.ok(component.institutionalInformationDetails.isVisible);
