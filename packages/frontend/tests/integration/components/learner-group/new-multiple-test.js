...
module('Integration | Component | learner-group/new-multiple', function (hooks) {
  ...
  test('it renders', async function (assert) {
    await render(hbs`<LearnerGroup::NewMultiple @cancel={{(noop)}} @generateNewLearnerGroups={{(noop)}} />`);
  ...
  test('save', async function (assert) {
    ...
    await render(hbs`<LearnerGroup::NewMultiple @generateNewLearnerGroups={{this.save}} @cancel={{(noop)}} />`);
