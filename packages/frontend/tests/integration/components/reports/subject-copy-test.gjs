...
module('Integration | Component | reports/subject-copy', function (hooks) {
  ...
  test('it renders with auto-generated title', async function (assert) {
    ...
    assert.strictEqual(
      ...
      '/reports/subjects?selectedPrepositionalObject=instructor&selectedPrepositionalObjectId=100&selectedSubject=course&showNewReportForm=true&title=All%20Courses%20for%20Instructor%200%20guy%20M.%20Mc0son%20in%20%20(Copy)',
    );
