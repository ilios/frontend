...
module('Integration | Component | reports/subject/new/course', function (hooks) {
  ...
  test('it renders', async function (assert) {
    await render(
      hbs`<Reports::Subject::New::Course @currentId={{null}} @changeId={{(noop)}} @school={{null}} />`,
    );
  ...
  test('it renders selected course', async function (assert) {
    await render(
      hbs`<Reports::Subject::New::Course @currentId='2' @changeId={{(noop)}} @school={{null}} />`,
    );
...
/>`);
  ...
  test('it filters by school', async function (assert) {
    ...
    await render(
      hbs`<Reports::Subject::New::Course @currentId={{null}} @changeId={{(noop)}} @school={{this.school}} />`,
    );
