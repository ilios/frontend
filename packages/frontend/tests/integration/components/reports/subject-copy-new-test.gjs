...
module('Integration | Component | reports/subject-copy-new', function (hooks) {
  ...
  test('it renders', async function (assert) {
    ...
    assert.strictEqual(
      ...
      '/reports/subjects?editReport=true&selectedPrepositionalObject=instructor&selectedPrepositionalObjectId=100&selectedSubject=course&showNewReportForm=true&title=All%20Courses%20for%200%20guy%20M.%20Mc0son%20in%20',
    );
