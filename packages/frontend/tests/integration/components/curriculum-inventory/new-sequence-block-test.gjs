...
module('Integration | Component | curriculum-inventory/new-sequence-block', function (hooks) {
  ...
  test('it renders', async function (assert) {
    ...
    await render(
      <template>
        <NewSequenceBlock @report={{this.report}} @cancel={{(noop)}} @save={{(noop)}} />
      </template>,
    );
  ...
  test('save with defaults', async function (assert) {
    ...
    await render(
      <template>
        <NewSequenceBlock @report={{this.report}} @save={{this.save}} @cancel={{(noop)}} />
      </template>,
    );
  ...
  test('cancel', async function (assert) {
    ...
    await render(
      <template>
        <NewSequenceBlock @report={{this.report}} @save={{(noop)}} @cancel={{this.cancel}} />
      </template>,
    );
