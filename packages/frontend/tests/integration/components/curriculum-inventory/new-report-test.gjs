...
module('Integration | Component | curriculum-inventory/new-report', function (hooks) {
  ...
  test('it renders', async function (assert) {
    ...
    await render(
      <template>
        <NewReport @currentProgram={{this.program}} @save={{(noop)}} @cancel={{(noop)}} />
      </template>,
    );
  ...
  test('save', async function (assert) {
    ...
    await render(
      <template>
        <NewReport @currentProgram={{this.program}} @save={{this.save}} @cancel={{(noop)}} />
      </template>,
    );
  ...
  test('cancel', async function (assert) {
    ...
    await render(
      <template>
        <NewReport @currentProgram={{this.program}} @cancel={{this.cancel}} @save={{(noop)}} />
      </template>,
    );
