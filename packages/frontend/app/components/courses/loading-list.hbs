<table class="courses-loading-list" aria-hidden="true">
  <thead>
    <tr>
      <th colspan="8">
  ...
  <tbody>
    {{#each (repeat (random 3 10))}}
      <tr class="is-loading">
        <td class="text-left" colspan="8">{{truncate (repeat (random 3 10) "ilios rocks") 25}}</td>
      ...
      <tr class="courses-list-item">
        ...
        <td class="text-center hide-from-small-screen" colspan="2">
          {{format-date this.today day="2-digit" month="2-digit" year="numeric"}}
        </td>
