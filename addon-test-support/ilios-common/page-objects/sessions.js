import { clickable, create, fillable, hasClass, visitable } from 'ember-cli-page-object';
...
export default create({
  ...
  expandCollapseAllSessions: clickable(
    '[data-test-sessions-grid-header] [data-test-expand-collapse-all]'
  ),
